...
fun CompetitionStandingsModelDTO.toCompetitionStandingsEntity(): CompetitionStandingsEntity =
    CompetitionStandingsEntity().apply {
...
fun StandingDTO.toStandingEntity(): StandingEntity = StandingEntity().apply {
...
fun TableDTO?.toTableEntity(): TableEntity = TableEntity().apply {
...
fun CompetitionStandingsEntity?.toCompetitionStandings(): CompetitionStandings = CompetitionStandings(
...
fun CompetitionEmbeddedEntity?.toCompetition(): Competition = Competition(
...
fun StandingEntity.toStanding(): Standing = Standing(
...
fun TableEntity.toTable(): Table = Table(
    draw = draw,
    form = form,
