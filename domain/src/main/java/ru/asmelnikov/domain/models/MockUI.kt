...
fun getMockCompetitionsList(): List<Competition> = listOf(
    Competition(
        id = 2021,
        area = Area(
            id = 2072,
...
fun getMockStandings(): CompetitionStandings = CompetitionStandings(
    area = Area(
        id = 2072,
        name = "England",
        flag = "https://crests.football-data.org/770.svg",
...
fun getMockScorers(): List<Scorer> = listOf(
    Scorer(
        player = Player(
            id = 38101,
            name = "Erling Haaland",
...
fun getMockMatches(): Matches = Matches(
...
fun getMockHead2Head(): Head2head = Head2head(
    id = 538046,
...
fun getMockTeam(): TeamInfo = TeamInfo(
    id = "66",
...
fun getMockMatchesComplete(): List<Match> = listOf(
    Match(
        id = 537793,
...
fun getMockMatchesAhead(): List<Match> = listOf(
    Match(
        id = 538062,
...
fun getMockPlayer(): Person = Person(
    id = 38101,
